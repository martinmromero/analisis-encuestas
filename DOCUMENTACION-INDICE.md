...
| **[PERSISTENCIA-PRODUCCION.md](PERSISTENCIA-PRODUCCION.md)** | ⭐ **Persistencia de datos** | **Para entender qué se preserva en deployments** |
...
- ✅ **Comportamiento de diccionarios y configuraciones** (AGREGAN, no reemplazan)
- ✅ **Volúmenes Docker y protección de datos**
